...
export default function TypewriterTitle({
  ...
  return (
    <div className="relative mx-auto w-full max-w-4xl py-0">
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        <motion.div
          animate={{ opacity: 1 }}
          className="flex items-center gap-1 font-mono text-[20px] text-black tracking-tight md:text-6xl dark:text-white"
          initial={{ opacity: 0 }}
