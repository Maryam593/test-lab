      ...
      >
        <div
          className={cn(
            ...
            "after:rounded-[inherit] h-screen"
          )}
          style={{ borderRadius }}
        />
      </motion.div>
...
export default function ShapeHero({
  title1 = "Build Wealth with Real Estate.Smarter Decisions, Greater Returns.",
  title2 = "Propstake makes real estate accessible. Explore opportunities, track performance, and build long-term wealth without the guesswork.",
}: {
  title1?: string;
  title2?: string;
}) {
  ...
  return (
    <div className="relative flex max-h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-[#030303]">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            <Button className="rounded-[20px]">Get Started</Button>
          </motion.div>
        </div>
      </div>
